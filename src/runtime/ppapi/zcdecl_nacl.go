// ./mkzfile.py --include=/Users/jyh/veyron-root/environment/nacl_sdk/pepper_35/include/ppapi/c config.txt cdecl_nacl.got
...
const (
	...
	PP_WEBSOCKETSTATUSCODE_INTERNAL_SERVER_ERROR WebSocketCloseCode = 1011
	PP_AUDIOSAMPLERATE_44100 AudioSampleRate = 44100
	PP_ERROR_NOTSUPPORTED Error = -12
	PP_WEBSOCKETSTATUSCODE_USER_REGISTERED_MIN WebSocketCloseCode = 3000
	...
	PP_WEBSOCKETSTATUSCODE_NOT_SPECIFIED WebSocketCloseCode = 1005
	...
	PP_WEBSOCKETSTATUSCODE_UNSUPPORTED_DATA WebSocketCloseCode = 1003
	...
	PP_WEBSOCKETSTATUSCODE_NO_STATUS_RECEIVED WebSocketCloseCode = 1005
	...
	PP_WEBSOCKETSTATUSCODE_ABNORMAL_CLOSURE WebSocketCloseCode = 1006
	...
	PP_WEBSOCKETSTATUSCODE_PROTOCOL_ERROR WebSocketCloseCode = 1002
	...
	PP_WEBSOCKETSTATUSCODE_NORMAL_CLOSURE WebSocketCloseCode = 1000
	...
	PP_WEBSOCKETSTATUSCODE_USER_REGISTERED_MAX WebSocketCloseCode = 3999
	...
	PP_WEBSOCKETSTATUSCODE_MESSAGE_TOO_BIG WebSocketCloseCode = 1009
	...
	PP_WEBSOCKETSTATUSCODE_GOING_AWAY WebSocketCloseCode = 1001
	...
	PP_WEBSOCKETSTATUSCODE_USER_PRIVATE_MAX WebSocketCloseCode = 4999
	...
	PP_WEBSOCKETSTATUSCODE_USER_PRIVATE_MIN WebSocketCloseCode = 4000
	...
	PP_WEBSOCKETSTATUSCODE_TLS_HANDSHAKE WebSocketCloseCode = 1015
	PP_VIDEOFRAME_FORMAT_I420 VideoFrameFormat = 2
	PP_WEBSOCKETSTATUSCODE_POLICY_VIOLATION WebSocketCloseCode = 1008
	PP_MAKEDIRECTORYFLAG_NONE MakeDirectoryFlag = 0 << 0
	PP_FILESYSTEMTYPE_ISOLATED FileSystemType = 4
	PP_WEBSOCKETSTATUSCODE_MANDATORY_EXTENSION WebSocketCloseCode = 1010
	...
	PP_WEBSOCKETSTATUSCODE_INVALID_FRAME_PAYLOAD_DATA WebSocketCloseCode = 1007
...
func ppb_audio_create(instance pp_Instance, config pp_Resource, callback pp_AudioCallback, user_data *byte) pp_Resource
func ppb_audio_is_audio(resource pp_Resource) pp_Bool
func ppb_audio_get_current_config(resource pp_Resource) pp_Resource
func ppb_audio_start_playback(resource pp_Resource) pp_Bool
func ppb_audio_stop_playback(resource pp_Resource) pp_Bool
func ppb_audiobuffer_is_audio_buffer(resource pp_Resource) pp_Bool
func ppb_audiobuffer_get_timestamp(resource pp_Resource) pp_TimeDelta
func ppb_audiobuffer_set_timestamp(resource pp_Resource)
func ppb_audiobuffer_get_sample_rate(resource pp_Resource) AudioBufferSampleRate
func ppb_audiobuffer_get_sample_size(resource pp_Resource) AudioBufferSampleSize
func ppb_audiobuffer_get_number_of_channels(resource pp_Resource) uint32
func ppb_audiobuffer_get_number_of_samples(resource pp_Resource) uint32
func ppb_audiobuffer_get_data_buffer(resource pp_Resource) *byte
func ppb_audiobuffer_get_data_buffer_size(resource pp_Resource) uint32
func ppb_audioconfig_create_stereo_16bit(instance pp_Instance, sample_rate uint32, sample_frame_count uint32) pp_Resource
func ppb_audioconfig_recommend_sample_frame_count(instance pp_Instance, sample_rate uint32, requested_sample_frame_count uint32) uint32
func ppb_audioconfig_is_audio_config(resource pp_Resource) pp_Bool
func ppb_audioconfig_get_sample_rate(resource pp_Resource) AudioSampleRate
func ppb_audioconfig_get_sample_frame_count(resource pp_Resource) uint32
func ppb_audioconfig_recommend_sample_rate(instance pp_Instance) AudioSampleRate
func ppb_console_log(instance pp_Instance, level LogLevel, value pp_Var)
func ppb_console_log_with_source(instance pp_Instance, level LogLevel, source pp_Var, value pp_Var)
func ppb_core_add_ref_resource(resource pp_Resource)
func ppb_core_release_resource(resource pp_Resource)
func ppb_core_get_time(resource pp_Resource) pp_Time
func ppb_core_get_time_ticks(resource pp_Resource) pp_TimeTicks
func ppb_fileio_create(instance pp_Instance) pp_Resource
func ppb_fileio_is_file_io(resource pp_Resource) pp_Bool
func ppb_fileio_open(file_io pp_Resource, file_ref pp_Resource, open_flags int32, cb pp_CompletionCallback) int32
func ppb_fileio_query(file_io pp_Resource, info *pp_FileInfo, cb pp_CompletionCallback) int32
func ppb_fileio_touch(file_io pp_Resource, last_access_time pp_Time, last_modified_time pp_Time, cb pp_CompletionCallback) int32
func ppb_fileio_read(file_io pp_Resource, offset int64, buf *byte, bytes_to_write int32, cb pp_CompletionCallback) int32
func ppb_fileio_write(file_io pp_Resource, offset int64, buf *byte, bytes_to_write int32, cb pp_CompletionCallback) int32
func ppb_fileio_set_length(file_io pp_Resource, length int64, cb pp_CompletionCallback) int32
func ppb_fileio_flush(file_io pp_Resource, cb pp_CompletionCallback) int32
func ppb_fileio_close(file_io pp_Resource)
func ppb_fileref_create(fs pp_Resource, path *byte) pp_Resource
func ppb_fileref_is_file_ref(resource pp_Resource) pp_Bool
func ppb_fileref_get_file_system_type(file_ref pp_Resource) FileSystemType
func ppb_fileref_get_name(return_struct *pp_Var, file_ref pp_Resource)
func ppb_fileref_get_path(return_struct *pp_Var, file_ref pp_Resource)
func ppb_fileref_get_parent(file_ref pp_Resource) pp_Resource
func ppb_fileref_make_directory(dir_ref pp_Resource, mkdir_flags int32, cb pp_CompletionCallback) int32
func ppb_fileref_touch(file_ref pp_Resource, atime pp_Time, mtime pp_Time, cb pp_CompletionCallback) int32
func ppb_fileref_delete(file_ref pp_Resource, cb pp_CompletionCallback) int32
func ppb_fileref_rename(file_ref pp_Resource, new_file_ref pp_Resource, cb pp_CompletionCallback) int32
func ppb_fileref_query(file_ref pp_Resource, info *pp_FileInfo, cb pp_CompletionCallback) int32
func ppb_fileref_read_directory_entries(file_ref pp_Resource, output pp_ArrayOutput, cb pp_CompletionCallback) int32
func ppb_filesystem_create(instance pp_Instance, ty FileSystemType) pp_Resource
func ppb_filesystem_is_file_system(resource pp_Resource) pp_Bool
func ppb_filesystem_open(resource pp_Resource, expected_size int64, cb pp_CompletionCallback) int32
func ppb_filesystem_get_type(resource pp_Resource) FileSystemType
func ppb_fullscreen_is_fullscreen(instance pp_Instance) pp_Bool
func ppb_fullscreen_set_fullscreen(instance pp_Instance, fullscreen pp_Bool) pp_Bool
func ppb_fullscreen_get_screen_size(instance pp_Instance, size *Size) pp_Bool
func ppb_gamepad_sample(instance pp_Instance, data *pp_GamepadSampleData)
func ppb_graphics2d_create(instance pp_Instance, size *Size, is_always_opaque pp_Bool) pp_Resource
func ppb_graphics2d_is_graphics2d(resource pp_Resource) pp_Bool
func ppb_graphics2d_describe(resource pp_Resource, size *Size, is_always_opaque *pp_Bool) pp_Bool
func ppb_graphics2d_paint_image_data(resource pp_Resource, image_data pp_Resource, top_left *Point, src_rect *Rect)
func ppb_graphics2d_scroll(resource pp_Resource, clip_rect *Rect, amount *Point) *Point
func ppb_graphics2d_replace_contents(resource pp_Resource, image_data pp_Resource)
func ppb_graphics2d_flush(resource pp_Resource, cb pp_CompletionCallback) int32
func ppb_graphics2d_set_scale(resource pp_Resource, scale float32) pp_Bool
func ppb_graphics2d_get_scale(resource pp_Resource) float32
func ppb_graphics3d_get_attrib_max_value(instance pp_Instance, attr int32, value *int32) int32
func ppb_graphics3d_create(instance pp_Instance, share_context pp_Resource, attrib_list *int32) pp_Resource
func ppb_graphics3d_is_graphics3d(resource pp_Resource) pp_Bool
func ppb_graphics3d_get_attribs(resource pp_Resource, attrib_list *int32) int32
func ppb_graphics3d_set_attribs(resource pp_Resource, attrib_list *int32) int32
func ppb_graphics3d_get_error(resource pp_Resource) int32
func ppb_graphics3d_resize_buffers(resource pp_Resource, width int32, height int32) int32
func ppb_hostresolver_create(instance pp_Instance) pp_Resource
func ppb_hostresolver_is_host_resolver(resource pp_Resource) pp_Bool
func ppb_hostresolver_resolve(resolver pp_Resource, host *byte, port uint16, hint *pp_HostResolverHint, cb pp_CompletionCallback) int32
func ppb_hostresolver_get_canonical_name(return_struct *pp_Var, resolver pp_Resource)
func ppb_hostresolver_get_net_address_count(resolver pp_Resource) uint32
func ppb_hostresolver_get_net_address(resolver pp_Resource, index uint32) pp_Resource
func ppb_imagedata_get_native_image_data_format() ImageDataFormat
func ppb_imagedata_is_image_data_supported(format ImageDataFormat) pp_Bool
func ppb_imagedata_create(instance pp_Instance, format ImageDataFormat, size *Size, init_to_zero pp_Bool) pp_Resource
func ppb_imagedata_is_image_data(image_data pp_Resource) pp_Bool
func ppb_imagedata_describe(image_data pp_Resource, desc *ImageDataDesc) pp_Bool
func ppb_imagedata_map(image_data pp_Resource) *byte
func ppb_imagedata_unmap(image_data pp_Resource)
func ppb_inputevent_request_input_events(instance pp_Instance, event_classes uint32) int32
func ppb_inputevent_request_filtering_input_events(instance pp_Instance, event_classes uint32) int32
func ppb_inputevent_clear_input_event_request(instance pp_Instance, event_classes uint32)
func ppb_inputevent_is_input_event(resource pp_Resource) pp_Bool
func ppb_inputevent_get_type(event pp_Resource) InputEventType
func ppb_inputevent_get_time_stamp(event pp_Resource) pp_TimeTicks
func ppb_inputevent_get_modifiers(event pp_Resource) uint32
func ppb_instance_bind_graphics(instance pp_Instance, device pp_Resource) pp_Bool
func ppb_instance_is_full_frame(instance pp_Instance) pp_Bool
func ppb_keyboardinputevent_create(instance pp_Instance, ty InputEventType, ticks pp_TimeTicks, modifiers uint32, key_code uint32, text pp_Var, code pp_Var) pp_Resource
func ppb_keyboardinputevent_is_keyboard_input_event(resource pp_Resource) pp_Bool
func ppb_keyboardinputevent_get_key_code(event pp_Resource) uint32
func ppb_keyboardinputevent_get_character_text(return_struct *pp_Var, event pp_Resource)
func ppb_keyboardinputevent_get_code(return_struct *pp_Var, event pp_Resource)
func ppb_mediastreamaudiotrack_is_media_stream_audio_track(resource pp_Resource) pp_Bool
func ppb_mediastreamaudiotrack_configure(audio_track pp_Resource, attribs *int32, cb pp_CompletionCallback) int32
func ppb_mediastreamaudiotrack_get_attrib(audio_track pp_Resource, attrib MediaStreamAudioTrackAttrib, value *int32) int32
func ppb_mediastreamaudiotrack_get_id(return_struct *pp_Var, audio_track pp_Resource)
func ppb_mediastreamaudiotrack_has_ended(audio_track pp_Resource) pp_Bool
func ppb_mediastreamaudiotrack_get_buffer(audio_track pp_Resource, buffer *pp_Resource, cb pp_CompletionCallback) int32
func ppb_mediastreamaudiotrack_recycle_buffer(audio_track pp_Resource, buffer pp_Resource) int32
func ppb_mediastreamaudiotrack_close(audio_track pp_Resource)
func ppb_mediastreamvideotrack_is_media_stream_video_track(resource pp_Resource) pp_Bool
func ppb_mediastreamvideotrack_configure(video_track pp_Resource, attribs *int32, cb pp_CompletionCallback) int32
func ppb_mediastreamvideotrack_get_attrib(video_track pp_Resource, attrib MediaStreamVideoTrackAttrib, value *int32) int32
func ppb_mediastreamvideotrack_get_id(return_struct *pp_Var, video_track pp_Resource)
func ppb_mediastreamvideotrack_has_ended(video_track pp_Resource) pp_Bool
func ppb_mediastreamvideotrack_get_buffer(video_track pp_Resource, buffer *pp_Resource, cb pp_CompletionCallback) int32
func ppb_mediastreamvideotrack_recycle_frame(video_track pp_Resource, buffer pp_Resource) int32
func ppb_mediastreamvideotrack_close(video_track pp_Resource)
func ppb_messaging_post_message(instance pp_Instance, msg pp_Var)
func ppb_mouse_cursor_set_cursor(instance pp_Instance, ty MouseCursorType, image pp_Resource, hot_spot *Point) pp_Bool
func ppb_mouseinputevent_create(instance pp_Instance, ty InputEventType, ticks pp_TimeTicks, modifiers uint32, button InputEventMouseButton, position *Point, clicks int32, movement *Point) pp_Resource
func ppb_mouseinputevent_is_mouse_input_event(resource pp_Resource) pp_Bool
func ppb_mouseinputevent_get_button(event pp_Resource) InputEventMouseButton
func ppb_mouseinputevent_get_position(return_struct *Point, event pp_Resource)
func ppb_mouseinputevent_get_click_count(event pp_Resource) int32
func ppb_mouseinputevent_get_movement(return_struct *Point, event pp_Resource)
func ppb_mouselock_lock_mouse(instance pp_Instance, cb pp_CompletionCallback) int32
func ppb_mouselock_unlock_mouse(instance pp_Instance)
func ppb_netaddress_create_from_ipv4_address(instance pp_Instance, addr *pp_NetAddress_IPv4) pp_Resource
func ppb_netaddress_create_from_ipv6_address(instance pp_Instance, addr *pp_NetAddress_IPv6) pp_Resource
func ppb_netaddress_is_net_address(resource pp_Resource) pp_Bool
func ppb_netaddress_get_family(addr pp_Resource) NetAddressFamily
func ppb_netaddress_describe_as_string(return_struct *pp_Var, addr pp_Resource, include_port pp_Bool)
func ppb_netaddress_describe_as_ipv4_address(addr pp_Resource, ipv4 *pp_NetAddress_IPv4) pp_Bool
func ppb_netaddress_describe_as_ipv6_address(addr pp_Resource, ipv6 *pp_NetAddress_IPv6) pp_Bool
func ppb_networklist_is_network_list(resource pp_Resource) pp_Bool
func ppb_networklist_get_count(resource pp_Resource) uint32
func ppb_networklist_get_name(return_struct *pp_Var, resource pp_Resource, index uint32)
func ppb_networklist_get_type(resourc pp_Resource, index uint32) NetworkListType
func ppb_networklist_get_state(resource pp_Resource, index uint32) NetworkListState
func ppb_networklist_get_ip_addresses(resource pp_Resource, index uint32, output *pp_ArrayOutput) int32
func ppb_networklist_get_display_name(return_struct *pp_Var, resource pp_Resource, index uint32)
func ppb_networklist_get_mtu(resource pp_Resource, index uint32) uint32
func ppb_network_monitor_create(instance pp_Instance) pp_Resource
func ppb_network_monitor_update_network_list(monitor pp_Resource, network_list *pp_Resource, cb pp_CompletionCallback) int32
func ppb_network_monitor_is_network_monitor(resource pp_Resource) pp_Bool
func ppb_networkproxy_get_proxy_for_url(instance pp_Instance, url pp_Var, proxy_string *pp_Var, cb pp_CompletionCallback) int32
func ppb_tcpsocket_create(instance pp_Instance) pp_Resource
func ppb_tcpsocket_is_tcp_socket(resource pp_Resource) pp_Bool
func ppb_tcpsocket_bind(socket pp_Resource, addr pp_Resource, cb pp_CompletionCallback) int32
func ppb_tcpsocket_connect(socket pp_Resource, addr pp_Resource, cb pp_CompletionCallback) int32
func ppb_tcpsocket_get_local_address(socket pp_Resource) pp_Resource
func ppb_tcpsocket_get_remote_address(socket pp_Resource) pp_Resource
func ppb_tcpsocket_read(socket pp_Resource, buf *byte, bytes_to_read int32, cb pp_CompletionCallback) int32
func ppb_tcpsocket_write(socket pp_Resource, buf *byte, bytes_to_write int32, cb pp_CompletionCallback) int32
func ppb_tcpsocket_listen(socket pp_Resource, backlog int32, cb pp_CompletionCallback) int32
func ppb_tcpsocket_accept(socket pp_Resource, accepted *pp_Resource, cb pp_CompletionCallback) int32
func ppb_tcpsocket_close(socket pp_Resource)
func ppb_tcpsocket_set_option(socket pp_Resource, name TCPSocketOption, value pp_Var, cb pp_CompletionCallback) int32
func ppb_textinputcontroller_set_text_input_type(instance pp_Instance, ty TextInputType)
func ppb_textinputcontroller_update_caret_position(instance pp_Instance, caret *Rect)
func ppb_textinputcontroller_cancel_composition_text(instance pp_Instance)
func ppb_textinputcontroller_update_surrounding_text(instance pp_Instance, text pp_Var, caret uint32, anchor uint32)
func ppb_touchinput_event_create(instance pp_Instance, ty InputEventType, time_stamp pp_TimeTicks, modifiers uint32) pp_Resource
func ppb_touchinput_event_add_touch_point(event pp_Resource, list TouchListType, point *pp_TouchPoint)
func ppb_touchinput_event_is_touch_input_event(resource pp_Resource) pp_Bool
func ppb_touchinput_event_get_touch_count(resource pp_Resource, list TouchListType) uint32
func ppb_touchinput_event_get_touch_by_index(return_struct *pp_TouchPoint, resource pp_Resource, list TouchListType, index uint32)
func ppb_touchinput_event_get_touch_by_id(return_struct *pp_TouchPoint, resource pp_Resource, list TouchListType, id uint32)
func ppb_udpsocket_create(instance pp_Instance) pp_Resource
func ppb_udpsocket_is_udp_socket(resource pp_Resource) pp_Bool
func ppb_udpsocket_bind(socket pp_Resource, addr pp_Resource, cb pp_CompletionCallback) int32
func ppb_udpsocket_get_bound_address(socket pp_Resource) pp_Resource
func ppb_udpsocket_recvfrom(socket pp_Resource, buf *byte, num_bytes int32, addr *pp_Resource, cb pp_CompletionCallback) int32
func ppb_udpsocket_sendto(socket pp_Resource, buf *byte, num_bytes int32, addr pp_Resource, cb pp_CompletionCallback) int32
func ppb_udpsocket_close(socket pp_Resource)
func ppb_udpsocket_set_option(socket pp_Resource, opt UDPSocketOption, value pp_Var, cb pp_CompletionCallback) int32
func ppb_urlloader_create(instance pp_Instance) pp_Resource
func ppb_urlloader_is_url_loader(resource pp_Resource) pp_Bool
func ppb_urlloader_open(loader pp_Resource, request pp_Resource, cb pp_CompletionCallback) int32
func ppb_urlloader_follow_redirect(loader pp_Resource, cb pp_CompletionCallback) int32
func ppb_urlloader_get_upload_progress(loader pp_Resource, bytes_sent *int64, total_bytes *int64) pp_Bool
func ppb_urlloader_get_download_progress(loader pp_Resource, bytes_received *int64, total_bytes *int64) pp_Bool
func ppb_urlloader_get_response_info(loader pp_Resource) pp_Resource
func ppb_urlloader_read_response_body(loader pp_Resource, buf *byte, bytes_to_read int32, cb pp_CompletionCallback) int32
func ppb_urlloader_finish_streaming_to_file(loader pp_Resource, cb pp_CompletionCallback) int32
func ppb_urlloader_close(loader pp_Resource)
func ppb_urlrequestinfo_create(instance pp_Instance) pp_Resource
func ppb_urlrequestinfo_is_url_request_info(resource pp_Resource) pp_Bool
func ppb_urlrequestinfo_set_property(request pp_Resource, property URLRequestProperty, value pp_Var) pp_Bool
func ppb_urlrequestinfo_append_data_to_body(request pp_Resource, data *byte, len uint32) pp_Bool
func ppb_urlrequestinfo_append_file_to_body(request pp_Resource, file_ref pp_Resource, off int64, len int64, expected_mtime pp_Time) pp_Bool
func ppb_urlresponseinfo_is_url_response_info(resource pp_Resource) pp_Bool
func ppb_urlresponseinfo_get_property(return_struct *pp_Var, response pp_Resource, property URLResponseProperty)
func ppb_urlresponseinfo_get_body_as_file_ref(response pp_Resource) pp_Resource
func ppb_var_add_ref(v pp_Var)
func ppb_var_release(v pp_Var)
func ppb_var_from_utf8(return_struct *pp_Var, data *byte, len uint32)
func ppb_var_to_utf8(v pp_Var, len *uint32) *byte
func ppb_var_to_resource(v pp_Var) pp_Resource
func ppb_var_from_resource(return_struct *pp_Var, resource pp_Resource)
func ppb_vararray_create(return_struct *pp_Var)
func ppb_vararray_get(return_struct *pp_Var, array pp_Var, index uint32)
func ppb_vararray_set(array pp_Var, index uint32, v pp_Var) pp_Bool
func ppb_vararray_get_length(array pp_Var) uint32
func ppb_vararray_set_length(array pp_Var, len uint32) pp_Bool
func ppb_vararraybuffer_create(return_struct *pp_Var, size_in_bytes uint32)
func ppb_vararraybuffer_byte_length(array pp_Var, byte_length *uint32) pp_Bool
func ppb_vararraybuffer_map(array pp_Var) *byte
func ppb_vararraybuffer_unmap(array pp_Var)
func ppb_vardictionary_create(return_struct *pp_Var)
func ppb_vardictionary_get(return_struct *pp_Var, dict pp_Var, key pp_Var)
func ppb_vardictionary_set(dict pp_Var, key pp_Var, value pp_Var) pp_Bool
func ppb_vardictionary_delete(dict pp_Var, key pp_Var)
func ppb_vardictionary_has_key(dict pp_Var, key pp_Var) pp_Bool
func ppb_vardictionary_get_keys(return_struct *pp_Var, dict pp_Var)
func ppb_videoframe_is_video_frame(resource pp_Resource) pp_Bool
func ppb_videoframe_get_timestamp(frame pp_Resource) pp_TimeDelta
func ppb_videoframe_set_timestamp(frame pp_Resource, timestamp pp_TimeDelta)
func ppb_videoframe_get_format(frame pp_Resource) VideoFrameFormat
func ppb_videoframe_get_size(frame pp_Resource, size *Size) pp_Bool
func ppb_videoframe_get_data_buffer(frame pp_Resource) *byte
func ppb_videoframe_get_data_buffer_size(frame pp_Resource) uint32
func ppb_view_is_view(resource pp_Resource) pp_Bool
func ppb_view_get_rect(resource pp_Resource, rect *Rect) pp_Bool
func ppb_view_is_fullscreen(resource pp_Resource) pp_Bool
func ppb_view_is_visible(resource pp_Resource) pp_Bool
func ppb_view_is_page_visible(resource pp_Resource) pp_Bool
func ppb_view_get_clip_rect(resource pp_Resource, clip *Rect) pp_Bool
func ppb_view_get_device_scale(resource pp_Resource) float32
func ppb_view_get_css_scale(resource pp_Resource) float32
func ppb_websocket_create(instance pp_Instance) pp_Resource
func ppb_websocket_is_web_socket(resource pp_Resource) pp_Bool
func ppb_websocket_connect(socket pp_Resource, url pp_Var, protocols *pp_Var, protocol_count uint32, cb pp_CompletionCallback) int32
func ppb_websocket_close(socket pp_Resource, code uint16, reason pp_Var, cb pp_CompletionCallback) int32
func ppb_websocket_receive_message(socket pp_Resource, message *pp_Var, cb pp_CompletionCallback) int32
func ppb_websocket_send_message(socket pp_Resource, msg pp_Var) int32
func ppb_websocket_get_buffered_amount(socket pp_Resource) uint64
func ppb_websocket_get_close_cose(socket pp_Resource) uint16
func ppb_websocket_get_close_reason(return_struct *pp_Var, socket pp_Resource)
func ppb_websocket_get_close_was_clean(socket pp_Resource) pp_Bool
func ppb_websocket_get_extensions(return_struct *pp_Var, socket pp_Resource)
func ppb_websocket_get_protocol(return_struct *pp_Var, socket pp_Resource)
func ppb_websocket_get_ready_state(socket pp_Resource) WebSocketReadyState
func ppb_websocket_get_url(return_struct *pp_Var, socket pp_Resource)
func ppb_wheelinputevent_create(instance pp_Instance, time_stamp pp_TimeTicks, modifiers uint32, wheel_delta *FloatPoint, wheel_tick *FloatPoint, scroll_by_page pp_Bool) pp_Resource
func ppb_wheelinputevent_is_wheel_input_event(resource pp_Resource) pp_Bool
